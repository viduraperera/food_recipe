...
class UpdateDessertImage extends StatefulWidget {
  ...
  @override
  State<UpdateDessertImage> createState() => _UpdateDessertImageState();
}

class _UpdateDessertImageState extends State<UpdateDessertImage> {
  XFile? _imageFile;
  ...
  void _onImageButtonPressed(ImageSource source,
    ...
    try {
      ...
      setState(() {
        ...
        updateDessertdl.pickDessertImage(File(_imageFile!.path));
      });
    } catch (e) {
      setState(() {
        _pickImageError = e;
...
typedef OnPickImageCallbackForDesertUpdate = void Function(
